...
const DownstreamLeasedAssets: FC<Props> = ({ scope, company, setFinalScope, handleInputChange, showToast }) => {
      ...
      try {
        ...
        if (company) {
          const newScope3: any = {
            company: company?._id || '',
            scope: 3,
            type: types.DownstreamLeasedAssets,
...
export default DownstreamLeasedAssets;
