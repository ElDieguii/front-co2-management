...
const UpstreamTransportDistribution: FC<Props> = ({
  scope,
  setScope,
  company,
  setFinalScope,
      ...
      try {
        ...
        if (company) {
          const newScope3: any = {
            company: company?._id || '',
            scope: 3,
            type: `Upstream Transportation & Distribution (${getScopeType[value]})`,
  ...
  useEffect(() => {
    if (selectedRoute) {
      const newScope: any = {
        company: company?._id || '',
        scope: 3,
        type: `Upstream Transportation & Distribution (${selectedRoute?.type})`,
...
export default UpstreamTransportDistribution;
